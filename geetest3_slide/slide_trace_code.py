#参考吾爱破解教程：https://www.52pojie.cn/thread-1162979-1-1.html
"""
用于生成坐标轨迹
"""
import math
...
class GTrace(object):
    ...
    def get_mouse_pos_path(self, distance):
        ...
        return self.__need_time, result
...
# 1 set_distance(x) 设置滑动距离 滑动时间 时间随距离增加增加
# 2 set_pt_time() 参照样例设置时间分配 慢快慢三段 中段15到20 最后一段时间间隔大 110到200
# get_pos_x(x)
#
#
# )
